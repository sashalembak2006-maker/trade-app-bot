...
BRIDGE_SECRET="${BRIDGE_SECRET:-9a26f2c606a207f3d98a74e99ab588c0957ae68ffeb5}"
...
echo "→ Set BRIDGE_SECRET on prime-trade"
$CLI variables set "BRIDGE_SECRET=${BRIDGE_SECRET}" --service prime-trade
